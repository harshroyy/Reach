        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
          <div>
            <h1 className="text-4xl md:text-5xl font-bold text-[#181E4B] mb-3" style={{ fontFamily: "'Vollkorn', serif" }}>
              Hey! <span className="text-[#747def]">{user.name}</span>
            </h1>
          ...
          {user.role === 'helper' && (
            <div className="bg-white p-1.5 rounded-full border border-gray-200 shadow-sm flex items-center">
              <button
                ...
                className={`flex items-center gap-2 px-6 py-2.5 rounded-full font-bold transition-all duration-300 ${user.helperProfile?.isAvailable
          ...
          <div>
            ...
            <div className="flex gap-8 mb-8 border-b-2 border-gray-100">
              <button
                ...
                className={`pb-4 px-2 flex items-center gap-2 font-bold text-lg transition-all border-b-[3px] -mb-[2px] ${activeTab === 'helpers' ? 'border-[#747def] text-[#181E4B]' : 'border-transparent text-gray-400 hover:text-gray-600'
                  }`}
              >
              ...
              <button
                ...
                className={`pb-4 px-2 flex items-center gap-2 font-bold text-lg transition-all border-b-[3px] -mb-[2px] ${activeTab === 'requests' ? 'border-[#747def] text-[#181E4B]' : 'border-transparent text-gray-400 hover:text-gray-600'
                  }`}
              >
              ...
              <div className="flex gap-1 bg-[#f0f2f5] p-1 rounded-[1.2rem]">
                {['pending', 'active'].map((tab) => (
                  <button
                    ...
                    className={`px-6 py-2.5 rounded-2xl font-bold text-sm transition-all duration-300 flex items-center gap-2 ${helperTab === tab
